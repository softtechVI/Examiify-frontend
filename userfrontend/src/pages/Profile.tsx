...
//         <div className="p-6 text-xl font-bold border-b">User Panel</div>
//         <nav className="mt-4">
//           <button
...
//           <button
//             className={`w-full text-left px-6 py-3 hover:bg-gray-200 ${
//               activeTab === "session" ? "bg-gray-200 font-semibold" : ""
//             }`}
...
//         {activeTab === "profile" && (
//           <div className="max-w-2xl bg-white shadow-md rounded-md p-6">
...
//             </div>
//             <div className="mb-2">
//               <strong>Institute:</strong> {user.institute} ({user.instituteType})
//             </div>
//             <div className="mb-2">
...
//             </div>
//             <div className="mb-2">
//               <strong>AI Status:</strong> {user.aiStatus}
//             </div>
//             <div className="mb-2">
//               <strong>Validity:</strong>{" "}
//               {user.validStart ? new Date(user.validStart).toLocaleDateString() : "N/A"} -{" "}
//               {user.validUpto ? new Date(user.validUpto).toLocaleDateString() : "N/A"}
//             </div>
//           </div>
//         )}
...
//             <p>Session information will appear here.</p>
//           </div>
//         )}
//       </main>
//     </div>
